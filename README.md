...
Source code for Gameflattener. This plugin was generated using Nevermore's CLI.
...
3. Run `rojo build --plugin gameflattener.rbxm --watch` to serve the code
